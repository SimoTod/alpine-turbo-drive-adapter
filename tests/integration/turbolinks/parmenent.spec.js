...
describe('data-turbolinks-permanent elements', () => {
  it('keep the state when navigating to a new page', () => {
    cy.visit('/tests/res/turbolinks/permanent/index.html')
    ...
    cy.get('a').click()
    cy.url().should('equal', 'http://127.0.0.1:8080/tests/res/turbolinks/permanent/target.html')
  ...
  it('do not log errors when containing x-for and navigating to a new page', () => {
    cy.visit('/tests/res/turbolinks/permanent-for/index.html')
    ...
    // Navigate to the second page
    cy.get('a').click()
    cy.url().should('equal', 'http://127.0.0.1:8080/tests/res/turbolinks/permanent-for/target.html')
